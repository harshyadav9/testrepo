...
function App() {
  ...
  return (
    <div className="App">
      <header class="header ">
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark shadow" style="background-color: #186dd7;">
          <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="images/terilogo.png" width="150" alt="logo" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <span class="navbar-text ms-auto d-flex align-items-center">
                <svg version="1.1" height="40" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 119.97" style="enable-background:new 0 0 122.88 119.97" xml:space="preserve">
                  <g>
                ...
                <p class="mx-2 my-0 text-end">
                  <strong>Sat Jul 02 2022 11:23:51</strong> <br /><em>GMT+0530 (India Standard Time)</em>
                </p>
              </span>
            </div>
          </div>
